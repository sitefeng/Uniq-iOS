...
- (void)viewDidLoad
{
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kiPhoneWidthPortrait, kiPhoneHeightPortrait-kiPhoneTabBarHeight) style:UITableViewStyleGrouped];
    ...
    if(indexPath.section == 0)
    {
        switch (indexPath.row)
        {
            case 0: {
                ...
                JPUserLocator* locator = [[JPUserLocator alloc] initWithUser:[userArray firstObject]];
...
{
    NSString* message = @"Checkout Uniq- Personal College Application Guide";
