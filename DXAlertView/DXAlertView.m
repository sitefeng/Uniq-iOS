   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.font = [UIFont fontWithName:[JPFont defaultThinFont] size:22.0f];
        self.alertTitleLabel.textColor = [UIColor colorWithRed:20.0/255.0 green:30.0/255.0 blue:55.0/255.0 alpha:1];
        ...
        self.alertContentLabel.textColor = [UIColor colorWithRed:37.0/255.0 green:67.0/255.0 blue:107.0/255.0 alpha:1];
        self.alertContentLabel.font = [UIFont fontWithName:[JPFont defaultThinFont] size:17.0f];
...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:227.0/255.0 green:100.0/255.0 blue:83.0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:87.0/255.0 green:135.0/255.0 blue:173.0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.rightBtn setTitle:rigthTitle forState:UIControlStateNormal];
        [self.leftBtn setTitle:leftTitle forState:UIControlStateNormal];
        self.leftBtn.titleLabel.font = self.rightBtn.titleLabel.font = [UIFont fontWithName:[JPFont defaultThinFont] size:18];
